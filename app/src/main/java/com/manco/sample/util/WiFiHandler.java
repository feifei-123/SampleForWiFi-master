...
public class WiFiHandler {
    ...
    public void startScan() {
        ...
        if (null != wifiManager) {
            Log.d("WIFIX","WIfiManager startScan");
    ...
    public List<AccessPoint> getScanAp() {
        ...
        for (ScanResult result : results) {
            ...
            int networkId = isConfigured(accessPoint);//判断该热点是否连接过wifi，networkId >=0 则视为合法ID
            if (networkId > -1) {
...
//        }
        ...
        isRemoved =  wifiManager.saveConfiguration();
